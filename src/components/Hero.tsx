...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 ml-40 max-w-6xl mx-auto w-full">
        <div className="flex flex-col-reverse lg:flex-row items-center gap-12">
          <div className="text-center lg:text-left flex-1">
            <div className="mb-6 flex items-center justify-center lg:justify-start gap-4">
              <div className="flex -space-x-2">
                {[1, 2, 3].map((i) => (
                  <div
                    key={i}
                    className="w-10 h-10 rounded-full bg-gradient-to-r from-primary to-secondary border-2 border-background"
                  />
                ))}
              </div>
            ...
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-black mb-6 glow-text animate-glow">
              {displayText}
            ...
            <div className="flex items-center justify-center lg:justify-start gap-8 mt-8">
              ...
              <img
                src="/image.png"
                alt="Devfolio"
                className="h-20 md:h-30 rounded-md"
              />
            </div>
          </div>
          ...
          <div
            ref={imgRef}
            aria-hidden={false}
            className={`relative flex-shrink-0 w-[900px] h-[500px] rounded-2xl overflow-hidden shadow-2xl border border-transparent transition-all duration-700 ease-out transform ${
              imgVisible
          ...
          >
            ...
            <div className="absolute -inset-2 rounded-2xl blur-3xl opacity-40"
              style={{
                background:
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(180deg, rgba(0,0,0,0) 40%, rgba(2,6,23,0.55) 100%)",
